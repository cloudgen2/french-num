...
pub fn function(lang:Lang) {
    ...
    ask_n_check_animal(136, 1, 2, Animal::Rabbit, lang);
    for n in 136..141 {
        ask_n_check_animal(n, 1, 60, Animal::Rabbit, lang);
    }
    print_level(8, lang);
    ask_n_check_num(141, 80, 81, lang);
    for n in 142..154 {
        ask_n_check_num(n, 80, 100, lang);
    }
    ask_n_check_num(144, 90, 91, lang);
    ask_n_check_num(145, 91, 92, lang);
    ask_n_check_num(146, 92, 93, lang);
    ask_n_check_num(147, 93, 94, lang);
    ask_n_check_drink(148, 1, 2, Drink::Tea, lang);
    for n in 149..155 {
        ask_n_check_drink(n, 1, 20, Drink::Tea, lang);
    }

    ask_n_check_drink(156, 1, 2, Drink::Coffee, lang);
    for n in 157..161 {
        ask_n_check_drink(n, 1, 20, Drink::Coffee, lang);
    }
    print_level(9, lang);
    ask_n_check_drink(161, 1, 2, Drink::Water, lang);
    for n in 162..169 {
    ...
    ask_n_check_num(169, 100, 101, lang);
    print_level(10, lang);
